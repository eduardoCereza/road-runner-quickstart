...
public class Move_IMU {
    ...
    public void moveForwardStraight(DcMotorEx leftF, DcMotorEx leftB, DcMotorEx rightF, DcMotorEx rightB, IMU imu, double distanceCM, double speed) {
